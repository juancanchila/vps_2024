...
@Component({
  selector: 'app-resumen-arma-tu-equipo',
  templateUrl: './resumen-arma-tu-equipo.page.html',
  styleUrls: ['./resumen-arma-tu-equipo.page.scss'],
})
export class ResumenArmaTuEquipoPage implements OnInit {
  ...
  constructor(private router: Router, private auth: AuthService, public fb: FormBuilder,public alertController:AlertController) {
   ...
   async irAPagar(){
    ...
    if(this.FormSend.invalid){
      ...
      this.auth.CrearSencillaArmaTuEquipo(this.FormSend.value);
