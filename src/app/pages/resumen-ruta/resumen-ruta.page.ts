...
console.log(TotalDefinitivoParaVehiculosDestino1 + TotalDefinitivoParaVehiculosDestino2, ' res total domicilio')


var TotalDefinitivoParaVehiculos = TotalDefinitivoParaVehiculosDestino1 + TotalDefinitivoParaVehiculosDestino2;
  this.FormSend.controls.  field_precio_3.setValue(TotalDefinitivoParaVehiculos);
  ...
  console.log(resultadoTotalCostoDestino1 + resultadoTotalCostoDestino2, ' res total domicilio')
  
  
  var TotalDefinitivoParaVehiculos = resultadoTotalCostoDestino1 + resultadoTotalCostoDestino2;
    this.FormSend.controls.  field_precio_3.setValue(TotalDefinitivoParaVehiculos);
    localStorage.setItem('precioTarifaTotalRuta',TotalDefinitivoParaVehiculos.toString());
}
  }
