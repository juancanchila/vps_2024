...
//  this.FormSend.controls.field_valor_declarado.setValue(this.auth.resumenRuta.field_valor_declarado['0']['value']);
  ...
  this.FormSend.controls.field_prefijo_destino10.setValue(this.auth.resumenRuta.field_prefijo_destino10['0']['value']);
 
  this.FormSend.controls.body10.setValue(this.auth.resumenRuta.body10['0']['value']);
  this.FormSend.controls.contacto10.setValue(this.auth.resumenRuta.contacto10['0']['value']);

  this.FormSend.controls.destino10.setValue(this.auth.resumenRuta.destino10['0']['value']);

  this.FormSend.controls.locacion10.setValue(this.auth.resumenRuta.locacion10['0']['value']);
  ...
  this.FormSend.controls.field_nombre_c_destino10.setValue(this.auth.resumenRuta.field_nombre_c_destino10['0']['value']);
...
if( localStorage.getItem('locacionDestinoSeleccionada10') != localStorage.getItem('locacionOrigenSeleccionada') ){
  if( localStorage.getItem('tarifaExternaOrigen')>localStorage.getItem('tarifaExternaDestino10')){
    this.FormSend.controls.  field_precio_10.setValue(localStorage.getItem('tarifaExternaOrigen'));
    localStorage.setItem('precioTarifa10',localStorage.getItem('tarifaExternaOrigen'));
    //

  }else  if(localStorage.getItem('tarifaExternaDestino10') >localStorage.getItem('tarifaExternaOrigen')){
    this.FormSend.controls.  field_precio_10.setValue(localStorage.getItem('tarifaExternaDestino10'));
    localStorage.setItem('precioTarifa10',localStorage.getItem('tarifaExternaDestino10'));
    //
  ...
  if(this.precio_origen>this.precio_destino10){
    this.FormSend.controls.  field_precio_10.setValue(this.precio_origen);
    localStorage.setItem('precioTarifa10',this.precio_origen);
  }else if(this.precio_destino10>this.precio_origen){
    this.FormSend.controls.  field_precio_10.setValue(this.precio_destino10);
    localStorage.setItem('precioTarifa10',this.precio_destino10);
  }else{
    this.FormSend.controls.  field_precio_10.setValue(localStorage.getItem('tarifaOrigen'));
    localStorage.setItem('precioTarifa10',this.precio_destino10);
  }
  ...
  //calculo porcentaje destino 10
  var resultadoTotalCostoDestino10 = Number(this.FormSend.controls.field_precio_10.value) ;
  var porcentajeDestino10 = ( resultadoTotalCostoDestino10 * valorAgregado) / 100;
  
  console.log("Valor Agregado:", valorAgregado);
  console.log("Porcentaje de Valor Agregado:", porcentajeDestino10)
  console.log("Resultado Total de Costo - porcentaje:", resultadoTotalCostoDestino10 - porcentajeDestino10);
  var TotalDefinitivoParaVehiculosDestino10 = resultadoTotalCostoDestino10 - porcentajeDestino10;
  this.FormSend.controls.  field_precio_10.setValue(TotalDefinitivoParaVehiculosDestino10);
  localStorage.setItem('precioTarifa10',TotalDefinitivoParaVehiculosDestino10.toString());
  //calculo total definitivo
  // Calcula el resultado total
  
  console.log(TotalDefinitivoParaVehiculosDestino1 + TotalDefinitivoParaVehiculosDestino2 + TotalDefinitivoParaVehiculosDestino3 + TotalDefinitivoParaVehiculosDestino4 + TotalDefinitivoParaVehiculosDestino5 + TotalDefinitivoParaVehiculosDestino6 + TotalDefinitivoParaVehiculosDestino7 + TotalDefinitivoParaVehiculosDestino8 + TotalDefinitivoParaVehiculosDestino9 + TotalDefinitivoParaVehiculosDestino10, ' res total domicilio')
  
  
  var TotalDefinitivoParaVehiculos = TotalDefinitivoParaVehiculosDestino1 + TotalDefinitivoParaVehiculosDestino2 + TotalDefinitivoParaVehiculosDestino3  + TotalDefinitivoParaVehiculosDestino4 + TotalDefinitivoParaVehiculosDestino5 + TotalDefinitivoParaVehiculosDestino6 + TotalDefinitivoParaVehiculosDestino7 + TotalDefinitivoParaVehiculosDestino8 + TotalDefinitivoParaVehiculosDestino9 + TotalDefinitivoParaVehiculosDestino10;
  this.FormSend.controls.  field_precio_11.setValue(TotalDefinitivoParaVehiculos);
  ...
  localStorage.setItem('precioTarifa6',resultadoTotalCostoDestino6.toString());
   ...
   this.FormSend.controls.  field_precio_10.setValue(resultadoTotalCostoDestino10);
   localStorage.setItem('precioTarifa10',resultadoTotalCostoDestino10.toString());

  //calculo total definitivo
  // Calcula el resultado total
  
  console.log(resultadoTotalCostoDestino1 + resultadoTotalCostoDestino2 + resultadoTotalCostoDestino3 + resultadoTotalCostoDestino4 + resultadoTotalCostoDestino5 + resultadoTotalCostoDestino6 + resultadoTotalCostoDestino7 + resultadoTotalCostoDestino8 + resultadoTotalCostoDestino9 + resultadoTotalCostoDestino10, ' res total domicilio')
  
  
  var TotalDefinitivoParaVehiculos = resultadoTotalCostoDestino1 + resultadoTotalCostoDestino2 + resultadoTotalCostoDestino3  + resultadoTotalCostoDestino4 + resultadoTotalCostoDestino5 + resultadoTotalCostoDestino6 + resultadoTotalCostoDestino7 + resultadoTotalCostoDestino8 + resultadoTotalCostoDestino9 + resultadoTotalCostoDestino10;
  this.FormSend.controls.  field_precio_11.setValue(TotalDefinitivoParaVehiculos);
  localStorage.setItem('precioTarifaTotalRuta',TotalDefinitivoParaVehiculos.toString());
  }
  ...
  this.FormSend.controls. field_barrio_destino10.setValue(this.auth.resumenRuta. field_barrio_destino10['0']['value']);
