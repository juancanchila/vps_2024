...
//  this.FormSend.controls.field_valor_declarado.setValue(this.auth.resumenRuta.field_valor_declarado['0']['value']);
  ...
  var TotalDefinitivo =  resultadoTotalCostoDestino1 +  resultadoTotalCostoDestino2+  resultadoTotalCostoDestino3 + resultadoTotalCostoDestino4+resultadoTotalCostoDestino5+resultadoTotalCostoDestino6+resultadoTotalCostoDestino7+resultadoTotalCostoDestino8+resultadoTotalCostoDestino9+resultadoTotalCostoDestino10;
