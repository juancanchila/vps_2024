...
@Component({
  selector: 'app-resumen-ruta4',
  templateUrl: './resumen-ruta4.page.html',
  styleUrls: ['./resumen-ruta4.page.scss'],
})
export class ResumenRuta4Page implements OnInit {
...
console.log(TotalDefinitivoParaVehiculosDestino1 + TotalDefinitivoParaVehiculosDestino2 + TotalDefinitivoParaVehiculosDestino3 + TotalDefinitivoParaVehiculosDestino4, ' res total domicilio')


var TotalDefinitivoParaVehiculos = TotalDefinitivoParaVehiculosDestino1 + TotalDefinitivoParaVehiculosDestino2 + TotalDefinitivoParaVehiculosDestino3  + TotalDefinitivoParaVehiculosDestino4;
this.FormSend.controls.  field_precio_5.setValue(TotalDefinitivoParaVehiculos);
...
console.log(resultadoTotalCostoDestino1 + resultadoTotalCostoDestino2 + resultadoTotalCostoDestino3 + resultadoTotalCostoDestino4, ' res total domicilio')


var TotalDefinitivoParaVehiculos = resultadoTotalCostoDestino1 + resultadoTotalCostoDestino2 + resultadoTotalCostoDestino3 +  resultadoTotalCostoDestino4;
this.FormSend.controls.  field_precio_5.setValue(TotalDefinitivoParaVehiculos);
localStorage.setItem('precioTarifaTotalRuta',TotalDefinitivoParaVehiculos.toString());
}
