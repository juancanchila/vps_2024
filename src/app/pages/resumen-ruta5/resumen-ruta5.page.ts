...
@Component({
  selector: 'app-resumen-ruta5',
  templateUrl: './resumen-ruta5.page.html',
  styleUrls: ['./resumen-ruta5.page.scss'],
})
export class ResumenRuta5Page implements OnInit {
...
console.log(TotalDefinitivoParaVehiculosDestino1 + TotalDefinitivoParaVehiculosDestino2 + TotalDefinitivoParaVehiculosDestino3 + TotalDefinitivoParaVehiculosDestino4 + TotalDefinitivoParaVehiculosDestino5, ' res total domicilio')


var TotalDefinitivoParaVehiculos = TotalDefinitivoParaVehiculosDestino1 + TotalDefinitivoParaVehiculosDestino2 + TotalDefinitivoParaVehiculosDestino3  + TotalDefinitivoParaVehiculosDestino4 + TotalDefinitivoParaVehiculosDestino5 ;
this.FormSend.controls.  field_precio_6.setValue(TotalDefinitivoParaVehiculos);
...
console.log(resultadoTotalCostoDestino1 + resultadoTotalCostoDestino2 + resultadoTotalCostoDestino3 + resultadoTotalCostoDestino4 + resultadoTotalCostoDestino5, ' res total domicilio')


var TotalDefinitivoParaVehiculos = resultadoTotalCostoDestino1 + resultadoTotalCostoDestino2 + resultadoTotalCostoDestino3  + resultadoTotalCostoDestino4 + resultadoTotalCostoDestino5;
this.FormSend.controls.  field_precio_6.setValue(TotalDefinitivoParaVehiculos);
localStorage.setItem('precioTarifaTotalRuta',TotalDefinitivoParaVehiculos.toString());
}
