...
@Component({
  selector: 'app-resumen-ruta6',
  templateUrl: './resumen-ruta6.page.html',
  styleUrls: ['./resumen-ruta6.page.scss'],
})
export class ResumenRuta6Page implements OnInit {
...
console.log(TotalDefinitivoParaVehiculosDestino1 + TotalDefinitivoParaVehiculosDestino2 + TotalDefinitivoParaVehiculosDestino3 + TotalDefinitivoParaVehiculosDestino4 + TotalDefinitivoParaVehiculosDestino5 + TotalDefinitivoParaVehiculosDestino6, ' res total domicilio')


var TotalDefinitivoParaVehiculos = TotalDefinitivoParaVehiculosDestino1 + TotalDefinitivoParaVehiculosDestino2 + TotalDefinitivoParaVehiculosDestino3  + TotalDefinitivoParaVehiculosDestino4 + TotalDefinitivoParaVehiculosDestino5 + TotalDefinitivoParaVehiculosDestino6;
this.FormSend.controls.  field_precio_7.setValue(TotalDefinitivoParaVehiculos);
...
console.log(resultadoTotalCostoDestino1 + resultadoTotalCostoDestino2 + resultadoTotalCostoDestino3 + resultadoTotalCostoDestino4 + resultadoTotalCostoDestino5 + resultadoTotalCostoDestino6, ' res total domicilio')


var TotalDefinitivoParaVehiculos = resultadoTotalCostoDestino1 + resultadoTotalCostoDestino2 + resultadoTotalCostoDestino3  + resultadoTotalCostoDestino4 + resultadoTotalCostoDestino5 + resultadoTotalCostoDestino6;
this.FormSend.controls.  field_precio_7.setValue(TotalDefinitivoParaVehiculos);
localStorage.setItem('precioTarifaTotalRuta',TotalDefinitivoParaVehiculos.toString());
}
