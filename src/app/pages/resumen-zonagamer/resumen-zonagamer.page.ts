...
@Component({
  selector: 'app-resumen-zonagamer',
  templateUrl: './resumen-zonagamer.page.html',
  styleUrls: ['./resumen-zonagamer.page.scss'],
})
export class ResumenZonagamerPage implements OnInit {
  FormSend: FormGroup;
  ...
  constructor(private router: Router, private auth: AuthService, public fb: FormBuilder,public alertController:AlertController) {
   ...
   async irAPagar(){
    ...
    if(this.FormSend.invalid){
      ...
      this.auth.CrearSencillaZonaGamer(this.FormSend.value);
