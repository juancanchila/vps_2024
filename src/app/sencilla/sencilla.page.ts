...
getValoresDeterminantesAuxiliar(){
  ...
  async WillEnterOrigen() {
    try {
      ...
      console.log(data);
      this.direccion = data;
   document.getElementById('itemOrigen').style.visibility = "visible";
      // Verificar si la dirección tiene solo un barrio y no es "San Andrés"
      if (this.direccion.length === 1 && this.direccion[0]['name'] !== 'San Andrés') {
        ...
        // Ocultar campo de barrio origen
        document.getElementById('itemOrigen').style.visibility = "visible";
      ...
      // Verificar si el barrio es "San Andrés"
        ...
        this.disabledValueOrigen = false;
  ...
  async WillEnter() {
    try {
      ...
      // Si hay más de un barrio disponible
        ...
        // Mostrar el campo de barrio origen
        document.getElementById('itemOrigen').style.visibility = "visible";
      }
    } catch (error) {
      console.log(error);
